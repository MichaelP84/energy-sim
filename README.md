### Started working with pycachism to simulate the caches, the only issue is according to the assigment: "The L1 cache is direct mapped and has a 32KB for instructions and 32KB for data"
